...
function Intro() {
    return (
        <div className='text-white pb-5'>
            ...
            <div>
            <p className='text-xl text-center md:text-left my-5 text-[#998F8F] font-liter'>A Developer who can Design, Develop & Deploy. nown for adaptability across the stack and a product-minded
